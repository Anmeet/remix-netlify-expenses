...
import { Link, useSearchParams, useTransition as useNavigation } from '@remix-run/react';
...
function AuthForm() {
  ...
  const validationErros = useActionData();
  ...
  return (
    <Form method="post" className="form" id="auth-form">
      ...
      {validationErros && (
        <ul>{Object.values(validationErros).map((error) =>(
