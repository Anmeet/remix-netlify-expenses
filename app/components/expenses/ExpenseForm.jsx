import { Form, Link, useActionData, useMatches, useParams, useSubmit, useTransition as useNavigation } from "@remix-run/react";
...
function ExpenseForm() {
  ...
  //ALternative way for submitting form
  ...
  return (
    <Form
    method={expenseData ? 'patch': 'post'} className="form" 
    id="expense-form"
